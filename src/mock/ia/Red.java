...
public class Red extends javax.swing.JFrame {
    ...
    private void initComponents() throws Exception {
        ...
        String output = "";
        String[][] data = new String[Database.Main.length("red")+1][10];
        ...
        {
            Player current = new Player(Database.Main.get(p, "name", "red"), Integer.parseInt(Database.Main.get(p, "num", "red")), Integer.parseInt(Database.Main.get(p, "pos", "red")), GUI.getTeam(2));
            for (Game g : GUI.getTeam(2).getGames())
            {
                current.addGame(g);
            }
